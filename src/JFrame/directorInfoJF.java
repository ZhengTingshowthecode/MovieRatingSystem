...
public class directorInfoJF extends JFrame {
    ...
    public void setListener(){
        jb.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                String[]s=movies_dao.getDirectors(jt.getText());
                jt1.setText(s[0]);
                jt2.setText(s[1]);
                jt3.setText(s[2]);
                jta.setText(movies_dao.movie_director(jt.getText()));
            }
        });
    }
