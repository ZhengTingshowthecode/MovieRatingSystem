...
public class userDeleteScoreJF extends JFrame {
    ...
    public void initJF(){
        this.setTitle("删除评分");
        this.setBounds(300,200,680,500);
    ...
    public void setListener(){
        jb.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                movie_dao.userDeleteScore(jt.getText(),jt1.getText());
                Vector<Vector<String>> list= movie_dao.userDeleteScore01(jt.getText());
                table.setModel(new javax.swing.table.DefaultTableModel(list,
                        new Vector<>(java.util.Arrays.asList("影名", "评分","评分时间"))));
            }
        });
