...
public class managerAction02_actAddJF extends JFrame {
    ...
    public managerAction02_actAddJF(){
        initJF();
        initPanel();
        setListener();
    }
    ...
    public void initPanel(){
        ...
        jl=new JLabel("演员1 id");
        jl1=new JLabel("演员2 id");
        jl2=new JLabel("演员3 id");
        jl3=new JLabel("演员1 名字");
        jl4=new JLabel("演员2 名字");
        jl5=new JLabel("演员3 名字");
    ...
    public void setListener(){
        jb.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                movie_dao.Act_Info(ss);
                movie_dao.managerAddAct(id,s);
                JOptionPane.showMessageDialog(managerAction02_actAddJF.this,
                        "添加成功！","提示",
